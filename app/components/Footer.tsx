                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-20">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#6366f1] to-[#06b6d4] flex items-center justify-center group-hover:scale-110 transition-transform">
                                ...
                                <div>
                                    ...
                                    <div className="text-white font-semibold">vamshi@example.com</div>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="text-white font-semibold">@vamsi__0</div>
                                </div>
                            </a>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 rounded-lg glass border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-[#6366f1] transition-colors"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                    rows={5}
                                    className="w-full px-4 py-3 rounded-lg glass border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-[#6366f1] transition-colors resize-none"
                            ...
                            <button
                                ...
                                className="w-full px-6 py-4 rounded-full bg-gradient-to-r from-[#6366f1] to-[#06b6d4] text-white font-semibold hover:shadow-lg hover:shadow-[#6366f1]/50 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                            >
